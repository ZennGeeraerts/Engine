...
dae::SDLSoundSystemImpl::SDLSoundSystemImpl()
	: m_PlaySounds{}
	, m_Mutex{}
{
...
void dae::SDLSoundSystemImpl::Play(const int id, const float volume, const std::string filePath)
{
...
void dae::SDLSoundSystemImpl::Update()
{
...
void dae::SDLSoundSystemImpl::PlaySDLSound(const PlaySound& playSound)
{
