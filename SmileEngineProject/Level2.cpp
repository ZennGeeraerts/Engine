...
dae::Level2::Level2(const GameSettings& gameSettings)
	: Scene(gameSettings)
{

}

void dae::Level2::CreateScene()
{
...
void dae::Level2::OnSceneEnd()
{
	...
	sceneManager.GetScene(3)->CreateScene();
}

void dae::Level2::CreateTilePositions(std::vector<glm::vec3>& tilePositions, float tileSize, int nrOfRows)
{
