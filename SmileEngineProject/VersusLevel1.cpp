...
dae::VersusLevel1::VersusLevel1(const GameSettings& gameSettings)
	: Scene(gameSettings)
{

}

void dae::VersusLevel1::CreateScene()
{
	...
	pCoilyController->SetIsInputControlled(true);
...
void dae::VersusLevel1::OnSceneEnd()
{
	auto& inputManager{ InputManager::GetInstance() };
	...
	MarkForRestart();
	sceneManager.GetScene(8)->CreateScene();
	sceneManager.SetScene(8);
}

void dae::VersusLevel1::CreateTilePositions(std::vector<glm::vec3>& tilePositions, float tileSize, int nrOfRows)
{
