...
dae::Level1::Level1(const GameSettings& gameSettings)
	: Scene(gameSettings)
{

}

void dae::Level1::CreateScene()
{
...
void dae::Level1::OnSceneEnd()
{
	...
	MarkForRestart();
	sceneManager.GetScene(2)->CreateScene();
	sceneManager.SetScene(2);
}

void dae::Level1::CreateTilePositions(std::vector<glm::vec3>& tilePositions, float tileSize, int nrOfRows)
{
