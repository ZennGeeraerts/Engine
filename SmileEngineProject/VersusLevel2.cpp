...
dae::VersusLevel2::VersusLevel2(const GameSettings& gameSettings)
	: Scene(gameSettings)
{

}

void dae::VersusLevel2::CreateScene()
{
...
void dae::VersusLevel2::OnSceneEnd()
{
	auto& inputManager{ InputManager::GetInstance() };
	...
	MarkForRestart();
	sceneManager.GetScene(9)->CreateScene();
	sceneManager.SetScene(9);
}

void dae::VersusLevel2::CreateTilePositions(std::vector<glm::vec3>& tilePositions, float tileSize, int nrOfRows)
{
