...
dae::Level3::Level3(const GameSettings& gameSettings)
	: Scene(gameSettings)
{

}

void dae::Level3::CreateScene()
{
	...
	inputManager.AddInputAction(SDL_SCANCODE_A, new MoveBottomLeft{ pPlayer.get(), InputManager::InputKeyAction::ePressed });
	inputManager.AddInputAction(SDL_SCANCODE_W, new MoveTopLeft{ pPlayer.get(), InputManager::InputKeyAction::ePressed });
	inputManager.AddInputAction(SDL_SCANCODE_D, new MoveTopRight{ pPlayer.get(), InputManager::InputKeyAction::ePressed });
	inputManager.AddInputAction(SDL_SCANCODE_S, new MoveBottomRight{ pPlayer.get(), InputManager::InputKeyAction::ePressed });
	...
	pGameManager->SetRevertTileOnMaxStage(true);
	Add(pGameObject);
}

void dae::Level3::OnSceneEnd()
{
	auto& inputManager{ InputManager::GetInstance() };
...
void dae::Level3::CreateTilePositions(std::vector<glm::vec3>& tilePositions, float tileSize, int nrOfRows)
{
