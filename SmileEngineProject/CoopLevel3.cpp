...
dae::CoopLevel3::CoopLevel3(const GameSettings& gameSettings)
	: Scene(gameSettings)
{

}

void dae::CoopLevel3::CreateScene()
{
...
void dae::CoopLevel3::OnSceneEnd()
{
	auto& inputManager{ InputManager::GetInstance() };
...
void dae::CoopLevel3::CreateTilePositions(std::vector<glm::vec3>& tilePositions, float tileSize, int nrOfRows)
{
